...
// H.M.Wang 2020-1-23 追加"10x8", "12x9", "14x10"字体
					...
					mFont.setText("7");
					mFont.setClickable(false);
				} else if (size.equalsIgnoreCase(MessageObject.mDotSizes[13])) {
					mFont.setText("7B");
					mFont.setClickable(false);
				} else if (size.equalsIgnoreCase(MessageObject.mDotSizes[14])) {
					mFont.setText("7L");
					mFont.setClickable(false);
				} else if (size.equalsIgnoreCase(MessageObject.mDotSizes[15])) {
					mFont.setText("7R");
					mFont.setClickable(false);
// End of H.M.Wang 2020-1-23 追加"10x8", "12x9", "14x10"字体
// End of H.M.Wang 2020-4-15 追加"5x5"字体
// H.M.Wang 2024-5-6 追加16@LB，16@RB字体
				} else if (size.equalsIgnoreCase(MessageObject.mDotSizes[16])) {
					mFont.setText("7LB");
					mFont.setClickable(false);
				} else if (size.equalsIgnoreCase(MessageObject.mDotSizes[17])) {
					mFont.setText("7RB");
					mFont.setClickable(false);
// End of H.M.Wang 2024-5-6 追加16@LB，16@RB字体
// H.M.Wang 2020-5-29 追加"19x13", "21x14"字体
				} else if (size.equalsIgnoreCase(MessageObject.mDot_32_Size[18])) {
					mFont.setText("19");
// H.M.Wang 2023-4-2 大字机在19，21时不锁定字体，但缺省设置最合适的字体
//					mFont.setClickable(false);
					mFont.setClickable(true);
// End of H.M.Wang 2023-4-2 大字机在19，21时不锁定字体，但缺省设置最合适的字体
				} else if (size.equalsIgnoreCase(MessageObject.mDot_32_Size[19])) {
					mFont.setText("21");
// H.M.Wang 2023-4-2 大字机在19，21时不锁定字体，但缺省设置最合适的字体
//					mFont.setClickable(false);
					mFont.setClickable(true);
...
// End of H.M.Wang 2020-5-29 追加"19x13", "21x14"字体
				} else if (size.equalsIgnoreCase(MessageObject.mDot_32_Size[20])) {
					mFont.setText("24");
					mFont.setClickable(true);
				} else {
					mFont.setClickable(true);
