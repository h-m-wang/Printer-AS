...
// H.M.Wang 2023-9-4 追加一个输出log到U盘的按键
			case R.id.btn_log_2usb:
				...
				Debug.d(TAG, "PHx = 0x" + Integer.toHexString(ExtGpio.readGpioTestPin('H', 14)));
				Debug.d(TAG, "PHx = 0x" + Integer.toHexString(ExtGpio.readGpioTestPin('H', 15)));
				TextView msg = (TextView) findViewById(R.id.output_msg);
				msg.setText("PH14=0x" + Integer.toHexString(ExtGpio.readGpioTestPin('H', 14)) + ", PH15=0x" + Integer.toHexString(ExtGpio.readGpioTestPin('H', 15)));
