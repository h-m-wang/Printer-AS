...
/*
    喷码机返回帧格式：
            -------------------------------------------------------------
            [STX] 				帧起始标志0x7e	1字节	    固定位置        7E
            [A] 				地址			    2字节	    固定位置        00 00
            [CMDID] 			命令    		    2字节	    固定位置        01 00
            [ACK/NAK]    		命令回应		    1字节	    固定位置        01
            [DEVSTATUS]		    设备状态		    1字节	    固定位置        00
            [CMDSTATUS]		    命令状态		    1字节	    固定位置        00
            <DATAINFO>     	    数据信息  		不定长       不固定位置
            [CHKSUM]   		    帧校验   		2字节	    不固定位置,  [ETX]前一位    XX XX
            [ETX]           	帧终止标志0x7f   1字节	    不固定位置      7F
  			-------------------------------------------------------------
*/
