...
public class LinearLayoutViews extends LinearLayout {
    private LinearLayoutBaseAdapter adapter;
    private OnItemClickListener onItemClickListener;

    public LinearLayoutViews(Context context) {
        super(context);
    }

    public LinearLayoutViews(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
