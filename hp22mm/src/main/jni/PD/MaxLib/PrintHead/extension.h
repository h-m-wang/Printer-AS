...
#define MULTIHEAD_GET_SET_RECIRC_OVERRIDE_IDX         43
#define MULTIHEAD_GET_SET_INK_DROPWEIGHT_OVERRIDE_IDX 44
#define MULTIHEAD_SET_PURGE_DONE_IDX                  45
...
#define MULTIHEAD_INK_DROPWEIGHT_GET   	    1
#define MULTIHEAD_INK_DROPWEIGHT_SET   	    2
...
#define MULTIHEAD_RECIRC_OVERRIDE_GET       1
#define MULTIHEAD_RECIRC_OVERRIDE_SET       2
