...
#else
	render = symbol->rendered = (struct zint_render *)alloca(sizeof(struct zint_render));
#endif
	render->lines = NULL;
	render->strings = NULL;
	render->rings = NULL;
...
#else
	line = (struct zint_render_line *)alloca(sizeof(struct zint_render_line));
#endif
	line->next = NULL;
	line->x = x;
	line->y = y;
...
#else
	ring = (struct zint_render_ring *)alloca(sizeof(struct zint_render_ring));
#endif
	ring->next = NULL;
	ring->x = x;
	ring->y = y;
...
#else
	hexagon = (struct zint_render_hexagon *)alloca(sizeof(struct zint_render_hexagon));
#endif
	hexagon->next = NULL;
	hexagon->x = x;
	hexagon->y = y;
...
#else
	string = (struct zint_render_string *)alloca(sizeof(struct zint_render_string));
#endif
	string->next = NULL;
	string->x = x;
	string->y = y;
...
#else
	string->text = (unsigned char *)alloca((ustrlen(text) + 1) * sizeof(unsigned char));
#endif
