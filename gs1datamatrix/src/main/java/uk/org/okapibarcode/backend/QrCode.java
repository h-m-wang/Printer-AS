...
public class QrCode extends Symbol {
    ...
    private EccLevel preferredEccLevel = null;
    ...
    protected void encode() {
        ...
        ecc_level = this.preferredEccLevel == null ? EccLevel.L : this.preferredEccLevel;
        switch (ecc_level) {
            case L:
            default:
                max_cw = 2956;
...
//        }
        ...
        if (this.preferredEccLevel != null && ecc_level != this.preferredEccLevel) {
            ecc_level = this.preferredEccLevel;
        }
//        if (this.preferredEccLevel == null) {
//            this.preferredEccLevel = ecc_level;
//        }
